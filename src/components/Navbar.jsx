...
const MenuItems = () => {
    return (
        <>
            ...
            <li className="text-black text-lg shadow-lg bg-red-100 rounded-md hover:shadow-sm hover:shadow-yellow-300"><Link to='/status'>Live Train Status</Link></li>
            <li className="text-black text-lg shadow-lg bg-red-100 rounded-md hover:shadow-sm hover:shadow-yellow-300"><Link to='/'>PNR Status</Link></li>
            <li className="text-black text-lg shadow-lg bg-red-100 rounded-md hover:shadow-sm hover:shadow-yellow-300"><Link to='/'>Time Table</Link></li>
            <li className="text-black text-lg shadow-lg bg-red-100 rounded-md hover:shadow-sm hover:shadow-yellow-300"><Link to='/'>Seat Available</Link></li>
